...
// Basemaps
const osmBase = new ol.layer.Tile({title:'OpenStreetMap',type:'base',visible:false,source:new ol.source.OSM({attributions:'© OSM contributors'})});
const cartoBase = new ol.layer.Tile({title:'CartoDB Dark',type:'base',visible:true,source:new ol.source.XYZ({url:'https://{a-d}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png',attributions:'© OSM © CARTO',maxZoom:19})});
